...
```{r mastodon par pays, echo=FALSE}
...
ggplot(top10_df, aes(x = reorder(Pays, -Nombre), y = Nombre)) +
  geom_bar(stat = "identity", fill = "skyblue") +
  labs(title = "Nombres de comptes Mastodon ouverts par les institutions de recherche par pays (10 pays ayant les plus hautes valeurs)", x = "Pays", y = "Nombre de comptes") +
  theme_minimal() +
